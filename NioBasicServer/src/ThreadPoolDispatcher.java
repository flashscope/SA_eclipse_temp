...
public class ThreadPoolDispatcher implements Dispatcher {
     ...
     */
	@Override
	public void startDispatching(final AsynchronousSocketChannel asynchronousSocketChannel, final HandleMap handlers) {
        for (int i = 0; i < (numThreads - 1); i++) {
            Thread thread = new Thread() {
                public void run() {
                    dispatchLoop(asynchronousSocketChannel, handlers);
                }
            };
            thread.start();
     ...
     */
    private void dispatchLoop(AsynchronousSocketChannel asynchronousSocketChannel, HandleMap handlers) {
